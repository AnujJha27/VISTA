...
def main() -> int:
    parser = argparse.ArgumentParser(description="Analyze exported VISTA structural-capability demo models")
    parser.add_argument("model_dir")
    parser.add_argument(
        "--constraints",
        default="examples/dft/structural-capability-input-constraints.json",
    )
    parser.add_argument("--output-dir", default="build/structural-capability-analysis")
